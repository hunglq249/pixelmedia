...
class ProductCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('zyk_admin.product_categories.index', compact('categories', 'keyword'));
    }
    ...
    public function edit($id)
    {
        ...
        $html = view('zyk_admin.product_categories.edit', compact('productCategory', 'title_vi', 'title_en'))->render();
        return response()->json(['html' => $html]);
    }
