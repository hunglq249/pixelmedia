...
class ArticleCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('zyk_admin.article_categories.index', compact('categories', 'keyword'));
    }
    ...
    {
        $html = view('zyk_admin.article_categories.create')->render();
    ...
    public function edit($id)
    {
        ...
        $html = view('zyk_admin.article_categories.edit', compact('category', 'title_vi', 'title_en'))->render();
        return response()->json(['html' => $html]);
    }
