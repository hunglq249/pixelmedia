...
class ArticleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('zyk_admin.articles.index', compact('keyword', 'result'));
    }
    ...
    public function create()
    {
        ...
        $html = view('zyk_admin.articles.create', compact('customCategories'))->render();
    ...
    public function show($id)
    {
        ...
        $html = view('zyk_admin.articles.show', compact('detail'))->render();
        return response()->json(['html' => $html]);
    }
    ...
    public function edit($id)
    {
        ...
        $html = view('zyk_admin.articles.edit', compact('customCategories', 'article', 'langData', 'ids'))->render();
        return response()->json(['html' => $html]);
    }
