...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.products.create', compact('customCategories', 'customTeams'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.products.show', compact('detail'));
    }
    ...
    public function edit($id)
    {
        ...
        $ids = implode(',', $ids);
        return view('admin.products.edit', compact('customCategories', 'customTeams', 'product', 'langData', 'ids'));
    }
