...
function initFormEvents($form) {
    ...
    if ($form.find('.tinymce').length > 0) {
        var editor_config = {
            path_absolute: '/',
            selector: '.tinymce',
            plugins: 'advlist autolink lists link image imagetools charmap print preview anchor textcolor searchreplace visualblocks code fullscreen insertdatetime media table contextmenu paste code help',
            toolbar: 'insertfile undo redo | fontselect styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media',
            height: 500,
            relative_urls: false,
            ...
            file_picker_callback: function (callback, value, meta) {
                ...
                var cmsURL = editor_config.path_absolute + 'laravel-filemanager?editor=tinymce5&field_name=' + meta.fieldname;
